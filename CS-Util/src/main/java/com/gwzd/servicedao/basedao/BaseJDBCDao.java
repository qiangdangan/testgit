...
public class BaseJDBCDao
{
	 ...
	 * @return
	 */
	public <T> AbstractEntityPersister getClassMetadata(Class<T> typClass)
	{
	 ...
	 * @return
	 */
	public <T> String getPrimaryKey(Class<T> typClass)
	{
	 ...
	 * @return
	 */
	public <T> String getPrimaryPropertyName(Class<T> typClass)
	{
	...
	public boolean updateEntiyFieldBySql(Object entity) throws Exception
	{
		...
		try
		{
			...
			for (PropertyDescriptor propertyDescriptor : propertyDescriptors)
			{
				...
				if (typeStr.contains("java.util.Set") || typeStr.contains("java.util.List") || typeStr.contains("java.lang.Class") || typeStr.equals("class") || name.trim().length() == 0)
				{
					continue;
				}
	...
	public Pager getListBySQLQuery(final String sql, Map<String, Object> parasMaps, BaseFindEntity findEntity) throws Exception
	{
		...
		try
		{
			...
			if (isFenYe.equals(ShiFouEnum.SHI))
			{
				...
				/*
				 * int page = findEntity.getPage(); pager.setPageNo(page); query.setFirstResult((page - 1) * pageSize);
				 */
