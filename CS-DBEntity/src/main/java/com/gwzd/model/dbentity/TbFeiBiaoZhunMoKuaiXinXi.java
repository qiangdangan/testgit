...
/**
 * TbFeiBiaoZhunMoKuaiXinXi entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "TB_FeiBiaoZhunMoKuaiXinXi")
public class TbFeiBiaoZhunMoKuaiXinXi implements java.io.Serializable
{
	...
	/** default constructor */
	public TbFeiBiaoZhunMoKuaiXinXi()
	{}

	/** minimal constructor */
	public TbFeiBiaoZhunMoKuaiXinXi(String jgxxid)
	{
		this.jgxxid = jgxxid;
	}

	/** full constructor */
	public TbFeiBiaoZhunMoKuaiXinXi(String mingCheng, String xingHao, String guiGe, String daiMa, String caiLiao, Double danJia, Double danZhong,
