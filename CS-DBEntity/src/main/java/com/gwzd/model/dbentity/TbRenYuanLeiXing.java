...
/**
 * TbRenYuanLeiXing entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "TB_RenYuanLeiXing")
public class TbRenYuanLeiXing implements java.io.Serializable
{
	...
	/** default constructor */
	public TbRenYuanLeiXing()
	{}

	/** full constructor */
	public TbRenYuanLeiXing(String leiXingMingCheng, Integer zhuangTai, String tianJiaRen, Timestamp tianJiaShiJian, String xiuGaiRen, Timestamp xiuGaiShiJian,
			String beiZhu)
	{
	...
	@Column(name = "RYLXID", unique = true, nullable = false, length = 50)
	...
	@Column(name = "LeiXingMingCheng", length = 100)
