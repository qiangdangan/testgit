...
<script type="text/javascript">
	...
	function initAddPage()
	{
		...
		$('#tbx_username').validatebox({
			required : true,
			validType : [
					"maxLength[100]", "remote['${cxt}test.ajaxValidateNameIsExist.action','姓名','hid_id']"
			]
		});
		//年龄
		$('#tbx_age').validatebox({
	...
	$(document).ready(function()
	{
		...
		{
			var url = "${cxt}test.updateDemo.action";
			$("#frm_demo").form({
				url : url,
				onSubmit : function()
				{
	...
	<div class="div-rightside">
		...
		<div class="main-frame">
			<form id="frm_demo" action="" method="post">
				<input type="hidden" id="hid_id" name="demo.id" value="${demo.id}"/>
				<!-- 组开始 -->
					...
					<div class="form-group col-sm-12">
						...
						<div class="fg-input">
							<input type="text" class="form-control"
								id="tbx_username" name ="demo.username" value="${demo.username}" placeholder="请输入姓名">
						</div>
					</div>
				</div>
				<!-- 组结束 -->
				...
				<div class="form-horizontal">
					<div class="form-group col-sm-6">
						...
						<div class="fg-input">
							<input type="text" class="form-control"
								id="tbx_age" name ="demo.age" value="${demo.age}" placeholder="请输入年龄">
						</div>
					</div>
					<div class="form-group col-sm-6">
						<label class="fg-text control-label">性别</label>
						<div class="fg-input">
							<select id="cmb_sex" name="demo.sex" class="select-dropkick" style="width:100%">
								<option value="">请选择</option>
								<option value="1" ${demo.sex eq '1' ? "selected='selected'" :"" }>男</option>
								<option value="2" ${demo.sex eq '2' ? "selected='selected'" :"" }>女</option>
							</select>
						</div>
					</div>
				</div>
				...
				<div class="form-horizontal">
					<div class="form-group col-sm-6 col-md-4">
						...
						<div class="fg-input">
							<input type="text" class="form-control"
								id="tbx_phone" name ="demo.phone" value="${demo.phone}" placeholder="请输入联系电话">
						</div>
					</div>
					<div class="form-group col-sm-6 col-md-4">
						...
						<div class="fg-input">
							<input type="text" class="form-control"
								id="tbx_email" name ="demo.email" value="${demo.email}" placeholder="请输入email">
						</div>
					</div>
					<div class="form-group col-sm-6 col-md-4">
						...
						<div class="fg-input">
							<input type="text" class="form-control"
								id="tbx_zhuanye" name ="demo.zhuanye" value="${demo.zhuanye}" placeholder="请输入专业">
						</div>
					</div>
					<div class="form-group col-sm-12">
						<label class="fg-text control-label">个人简介</label>
						<div class="fg-input">
							<textarea id="tbx_jianjie" name ="demo.jianjie" rows="" cols="" class="form-control" placeholder="请输入个人简介">${demo.jianjie}</textarea>
						</div>
					</div>
					<div class="form-btns">
