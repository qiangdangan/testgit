...
(function($)
{
	...
	function _b(_c)
	{
		var _d = $.extend( {}, $.fn.window.defaults, { collapsible : false, minimizable : false, maximizable : false, shadow : false, draggable : false, resizable : false, closed : true,
			style : { left : "", top : "", right : 0, zIndex : $.fn.window.defaults.zIndex++, bottom : -document.body.scrollTop - document.documentElement.scrollTop }, onBeforeOpen : function()
			{
	...
	function _f(_10, _11, _12)
	{
		...
		win.window( { title : _10, noheader : (_10 ? false : true), width : 300, height : "auto", modal : true, collapsible : false, minimizable : false, maximizable : false, resizable : false,
			onClose : function()
			{
				setTimeout(function()
				{
	...
	$.messager = {
		...
		{
			var _17 = "<div style=\"height:32px;vertical-align: center;text-align: center;\">" + msg + "</div>";
			switch (_16)
			{
				case "error":
		...
		{
			var _1a = "<div class=\"messager-icon messager-question\"></div>" + "<div style='height:32px;vertical-align: center;text-align: center;'>" + msg + "</div>" + "<div style=\"clear:both;\"/>";
			var _1b = {};
		...
		{
			var _1d = "<div class=\"messager-icon messager-question\"></div>" + "<div style='height:32px;vertical-align: center;text-align: center;'>" + msg + "</div>" + "<br/>" + "<div style=\"clear:both;\"/>"
